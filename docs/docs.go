...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "SaaSKit Support",
            "url": "https://github.com/medaminerjb/saas-kit/issues",
            "email": "support@saaskit.io"
        },
        "license": {
            "name": "MIT",
            "url": "https://github.com/medaminerjb/saas-kit/blob/main/LICENSE"
        },
        "version": "{{.Version}}"
    },
    "host": "{{.Host}}",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.switchTenantRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.updateTenantMetadataRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.updateMetadataRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "domain.APIKey": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/domain.APIKeyStatus"
                },
                "tenant_id": {
                    "type": "string"
                },
                "type": {
                    "$ref": "#/definitions/domain.APIKeyType"
                }
            }
        },
        "domain.APIKeyStatus": {
        ...
        "handler.updateTenantMetadataRequest": {
            "type": "object",
            "properties": {
                "metadata": {
                    "type": "object",
